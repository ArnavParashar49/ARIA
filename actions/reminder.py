...
try:
    ...
    notification.notify(title="NEO Reminder", message=message, timeout=15)
    notified = True
except Exception:
    pass
...
if not notified:
    try:
        ...
        ToastNotifier().show_toast("NEO Reminder", message, duration=15, threaded=False)
        notified = True
    except Exception:
        pass
...
"""
        ...
        title = "NEO Alarm" if alarm else "NEO Reminder"
        notify_block = f"""
message = {msg_literal}
notified = False
...
"""
    ...
    script_body = f"""# Auto-generated by NEO reminder — do not edit
...
def _schedule_windows(
    ...
    xml_content = (
        ...
        '  <RegistrationInfo><Description>NEO Reminder</Description></RegistrationInfo>\n'
...
def _list_scheduled() -> str:
    ...
    if not upcoming:
        return "No upcoming NEO scheduled reminders."
